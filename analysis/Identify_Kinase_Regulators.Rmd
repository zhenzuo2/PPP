...
for (ca in c("kirc", "hnsc", "lusc", "luad", "paad")) {
    ...
    expr_normal <- readRDS(paste("output/pho/count_matrix_", ca, "_normal.RDS",
        sep = ""))
    expr_tumor <- readRDS(paste("output/pho/count_matrix_", ca, "_tumor.RDS",
        sep = ""))
    ...
    saveRDS(dset, paste("output/pho/dset_", ca, ".RDS", sep = ""))
    saveRDS(regul, paste("output/pho/regul_", ca, ".RDS", sep = ""))
}
```
