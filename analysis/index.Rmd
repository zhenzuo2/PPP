...
# TO DO
Replace figure annoation seq_15 with gene_site. 
Read https://www.embopress.org/doi/full/10.15252/msb.20209730. 

Use BIKG, PPI, and a in house network shared by Faye for network. 
Cutoff 400 for string dataset.https://www.ncbi.nlm.nih.gov/pmc/articles/PMC6323986/
...
- Get list of Human Kinases from http://www.kinhub.org/kinases.html# [See more](extract_kinases_list.html).  
  + Remove features with more 20% zero/missing values. 
...
- Get Copy Number Variation from <a href="https://proteomic.datacommons.cancer.gov/pdc/cptac-pancancer"> CPTAC </a>.
- Use t-tests to find key features that show differences between tumor and normal tissues (adjusted p values < 0.05) [See more](Identify_CNV_Regulators.html).  

## Differential Methylation Analysis
- Get Methylation from <a href="https://proteomic.datacommons.cancer.gov/pdc/cptac-pancancer"> CPTAC </a>.
- Use two-side Wilcoxon Rank Sum and Signed Rank Tests with Benjamini & Hochberg correction (adjusted p values < 0.05) [See more](Differentially_Methylation.html).  
...
- Differentially activated kinase regulator [See more](Identify_Kinase_Regulators.html).  
...
## Summary of Regulators and Features
```{r}
